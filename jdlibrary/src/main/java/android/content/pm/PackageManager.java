...
public abstract class PackageManager {
     ...
     */
    public abstract @Nullable
    Intent getLeanbackLaunchIntentForPackage(@NonNull String packageName);
     ...
     */
    public abstract @Nullable
    Intent getCarLaunchIntentForPackage(@NonNull String packageName);
     ...
     */
    @CheckResult
    public abstract @PermissionResult
    ...
    public abstract @PermissionFlags
    int getPermissionFlags(String permissionName,
     ...
     */
    @CheckResult
    public abstract @SignatureResult
    ...
    List<InstantAppInfo> getInstantApps();
    ...
    @SystemApi
    public abstract @Nullable
    Drawable getInstantAppIcon(String packageName);
     ...
     */
    public abstract @NonNull
    List<SharedLibraryInfo> getSharedLibrariesAsUser(
    ...
    public List<ResolveInfo> queryBroadcastReceiversAsUser(Intent intent,
        ...
        return queryBroadcastReceiversAsUser(intent, flags, null);
    }
    ...
    public void getPackageSizeInfo(String packageName, IPackageStatsObserver observer) {
        getPackageSizeInfoAsUser(packageName, 1, observer);
    }
     ...
     */
    public abstract @Nullable
    VolumeInfo getPackageCurrentVolume(ApplicationInfo app);

    /**
     * {@hide}
     */
    public abstract @NonNull
    List<VolumeInfo> getPackageCandidateVolumes(ApplicationInfo app);
     ...
     */
    public abstract @NonNull
    List<VolumeInfo> getPrimaryStorageCandidateVolumes();
     ...
     */
    @TestApi
    public abstract @InstallReason
    int getInstallReason(String packageName,
                         @NonNull UserHandle user);
